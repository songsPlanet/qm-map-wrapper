...
var AnimationRoute = /*#__PURE__*/function () {
  function AnimationRoute(map, route) {
    ...
    // 目标路径 Feature<Geometry, Properties>[]
  ...
  return _createClass(AnimationRoute, [{
    ...
    value: function getIndex() {
      if (pointGeojson.features.length !== 0) {
        var _context;
        this.pauseIndex = _findIndexInstanceProperty(_context = this.route).call(_context, function (value) {
    ...
    value: function animateLine() {
      ...
      function task(index) {
        var coords = that.route[index].geometry.coordinates;
