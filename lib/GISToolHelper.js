...
function _unsupportedIterableToArray(r, a) {
  if (r) {
    ...
    var t = (0, _slice["default"])(_context4 = {}.toString.call(r)).call(_context4, 8, -1);
...
(0, _defineProperty2["default"])(GISToolHelper, "debounce", function (func, delay) {
  ...
  return function (args) {
    ...
    task = (0, _setTimeout2["default"])(function () {
      func(args);
    }, delay);
  };
});
...
(0, _defineProperty2["default"])(GISToolHelper, "transTreeToArr", function (list, tree) {
  if (!((0, _isArray["default"])(tree) && tree.length > 0)) return;
  (0, _forEach["default"])(tree).call(tree, function (father) {
    list.push(father);
...
(0, _defineProperty2["default"])(GISToolHelper, "loopBounds", function (bound, coordinates) {
  if (coordinates[0] instanceof Array) {
    (0, _forEach["default"])(coordinates).call(coordinates, function (item) {
...
/**
     ...
     * @returns {{}}
*/
(0, _defineProperty2["default"])(GISToolHelper, "multiPolygonToPolygon", function (multi, polygons) {
 ...
 * @returns {{}}
*/
(0, _defineProperty2["default"])(GISToolHelper, "modifyMultiPolygon", function (feats) {
  var polygons = [];
  (0, _forEach["default"])(feats).call(feats, function (feat) {
