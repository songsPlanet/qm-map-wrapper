...
function _objectSpread(e) {
  for (var r = 1; r < arguments.length; r++) {
    ...
    r % 2 ? (0, _forEach["default"])(_context4 = ownKeys(Object(t), !0)).call(_context4, function (r) {
      (0, _defineProperty3["default"])(e, r, t[r]);
    }) : _getOwnPropertyDescriptors["default"] ? (0, _defineProperties["default"])(e, (0, _getOwnPropertyDescriptors["default"])(t)) : (0, _forEach["default"])(_context5 = ownKeys(Object(t))).call(_context5, function (r) {
...
var MapWrapper = exports["default"] = /*#__PURE__*/function (_Map) {
  function MapWrapper(options) {
    ...
    (0, _defineProperty3["default"])(_this, "_id", void 0);
    /**
     * 获取mapOptions
     */
    (0, _defineProperty3["default"])(_this, "_options", void 0);
    /**
     * 获取MapLayerSetting
     */
    (0, _defineProperty3["default"])(_this, "_mapLayerSetting", void 0);
    /**
     * 获取images列表
     * {
     *  id:"imageID",
     ...
     * }[]
     */
    (0, _defineProperty3["default"])(_this, "_images", []);
    // 绘制工具
    (0, _defineProperty3["default"])(_this, "_drawTool", void 0);
    (0, _defineProperty3["default"])(_this, "_layers", []);
    (0, _defineProperty3["default"])(_this, "addDotIcon", function (point) {
     ...
     * @returns {[[*, *], [*, *], [*, *], [*, *]]}
     */
    (0, _defineProperty3["default"])(_this, "getMapExtent", function () {
     ...
     * @returns {[[*, *], [*, *], [*, *], [*, *]]}
     */
    (0, _defineProperty3["default"])(_this, "getBoundsExtent", function (bounds) {
  ...
  return (0, _createClass2["default"])(MapWrapper, [{
    ...
    */
    ...
    value: function addDrawFeature(data) {
      ...
      var modifyPolygon = _GISToolHelper["default"].modifyMultiPolygon(data);
      (0, _forEach["default"])(modifyPolygon).call(modifyPolygon, function (d) {
        var _this4$drawTool;
    ...
    */
    ...
    value: function locationFeatureByCoords(lonlat) {
      var bounds = new _mapboxGl.LngLatBounds(lonlat[0], lonlat[1]);
